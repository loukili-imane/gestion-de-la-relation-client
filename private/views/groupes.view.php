            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-gradient-primary">
                        <h6 class="m-0 font-weight-bold " style="color:white; text-align:center">Liste des groupes</h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 58px;">Description</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 31px;">Date Creation</th>
                                            ...
                                            <tbody>
                                                <?php if (isset($rows) && $rows) : ?>
                                                    ...
                                                    <?php foreach ($rows as $row) : ?>
                                                        <tr>
                                                            <td> <?= $row->id_groupe ?></td>
                                                            <td> <?= $row->nomGroupe ?></td>
                                                            <td> <?= $row->groupeDescription ?></td>
                                                            <td><?= get_date($row->dateCreation) ?></td>
                                                           
                                                            <td>
                                                                <a href="<?= ROOT ?>/classes/modifier/<?= $row->id_groupe ?>">
                                                                    <button class="btn-sm btn btn-info text-white"><i class="fa fa-edit"></i></button>
                                                                </a>

                                                                <a href="<?= ROOT ?>/groupes/delete/<?= $row->id_groupe ?>">
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="6">
                                                            <center>aucun groupe pour le moment</center>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
