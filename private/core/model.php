...
class Model extends Database
{
	...
	{
		//when we want to instanciate a class 
		//if the current Class does not have the attribut table we create one 
		//table represent the table name in the database that correspond to the current classe 
	...
	// retourner la clé primaire d'une table
